...
*13 models - Latest 2024-2025 architectures tested with standardized protocol*
...
*24 models - Historical tests and older model versions*
...
*16 test scripts - Early rapid testing and variants*
