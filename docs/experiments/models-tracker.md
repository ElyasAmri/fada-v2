...
**50+ models tested total** - see [[All Models Tested]] for full list
...
## TODO: Models to Evaluate on Full Test Set (1,494)

- [ ] MiniCPM-V-2.6 (needs ground truth eval)
- [ ] Qwen2-VL-2B (needs ground truth eval)
- [ ] InternVL2-4B (needs ground truth eval)
- [ ] Fine-tuned Qwen2.5-VL-7B (expand from 600 to 1,494)
- [ ] Llama 3.2 Vision
- [ ] Pixtral-12B
