"""Test Kimi-VL-A3B-Instruct - Moonshot AI's MoE vision-language model"""
...
print("="*70)
print("Kimi-VL-A3B-Instruct Test")
print("="*70)
...
try:
    print(f"\n1. Loading Kimi-VL-A3B-Instruct (2.8B active)...")
    ...
    print(f"   Size: {param_count / 1e9:.2f}B params total")
    ...
    print("\n" + "="*70)
    print("Kimi-VL-A3B-Instruct Test Complete")
    print("="*70)
