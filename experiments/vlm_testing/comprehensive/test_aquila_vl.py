"""Test Aquila-VL-2B - BAAI's LLaVA-based vision-language model"""
...
try:
    ...
    print("\n" + "="*70)
    print("Aquila-VL-2B Test Complete")
    print("="*70)
