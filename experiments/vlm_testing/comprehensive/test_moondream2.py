"""Test moondream2 - Efficient edge VLM"""
...
try:
    ...
    for i, img_path in enumerate(test_images[:6]):
        ...
        start = time.time()
        with torch.no_grad():
            response = model.answer_question(image_embeds, question, tokenizer)
    ...
    print("\n" + "="*70)
    print("moondream2 Test Complete")
    print("="*70)
