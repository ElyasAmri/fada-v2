"""Test InternVL 2.5-2B - Latest efficient multimodal model"""
...
try:
    ...
    for i, img_path in enumerate(test_images[:6]):
        ...
        # InternVL format - pass image path directly
    ...
    print("\n" + "="*70)
    print("InternVL 2.5-2B Test Complete")
    print("="*70)
