"""Test CheXagent-8b - Stanford medical VLM"""
...
print("="*70)
print("CheXagent-8b Test (Stanford Medical VLM)")
print("="*70)
...
try:
    ...
    for i, img_path in enumerate(test_images[:6]):
        ...
        # Medical VQA query
        query = "Describe this medical ultrasound image. What anatomical structures are visible?"
        ...
        elif hasattr(model, 'generate_caption'):
            response = model.generate_caption(image, query)
        else:
            # Standard generation
    ...
    print("\n" + "="*70)
    print("CheXagent-8b Test Complete")
    print("="*70)
