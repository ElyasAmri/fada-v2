...
class ConversationStore(context: Context) {
    ...
    fun load(): StoredConversationState? {
        ...
        return StoredConversationState(
            ...
            settings = AppSettings(
                keepImageAfterSend = root.optJSONObject("settings")
                    ?.optBoolean("keepImageAfterSend", true)
                    ?: true
            )
        )
    }
    ...
    fun save(
        ...
        val root = JSONObject()
            ...
            .put("settings", JSONObject().put("keepImageAfterSend", settings.keepImageAfterSend))
            .put(
                "conversations",
                JSONArray().apply {
